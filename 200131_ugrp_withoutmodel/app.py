...
def mbti():
    ...
    print("rows: ")
    print(rows)
    print("mbti result:", rows[0][0], "user_result:", temp, "userid: ", str(counter.value))
    return render_template('result.html', mbti_result = rows[0][0], user_result = temp, userid = str(counter.value))
