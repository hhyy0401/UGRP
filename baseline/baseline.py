...
# %%
train_dataset = image_dataset_from_directory(TARGET_PATH("train"),
                                             shuffle=True,
                                             batch_size=BATCH_SIZE,
                                             image_size=IMG_SIZE)
validation_dataset = image_dataset_from_directory(TARGET_PATH("validation"),
                                                  shuffle=True,
                                                  batch_size=BATCH_SIZE,
                                                  image_size=IMG_SIZE)
# %%
...
# Add top to the model
global_average_layer = tf.keras.layers.GlobalAveragePooling2D()
feature_batch_average = global_average_layer(feature_batch)
print(feature_batch_average.shape)

# Add prediction layer to base model
...
# Choose how many layers to train in pretrained model
fine_tune_at = 100
...
# 10 epochs after init 10 epochs
fine_tune_epochs = 10
